...
const ThemeSwitch = () => {
    ...
    return <>
        <input defaultChecked={theme === 'dark'} onChange={toggleTheme} type="checkbox" id="darkmode-toggle" />
        <label htmlFor="darkmode-toggle">
            <svg className="moon" xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
            ...
            <svg className="sun" xmlns="http://www.w3.org/2000/svg" fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" version="1.1">
